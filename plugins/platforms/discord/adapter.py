...
def _define_discord_view_classes() -> None:
    ...
    """
    global ExecApprovalView, SlashConfirmView, UpdatePromptView, ModelPickerView, ClarifyChoiceView, NewsArticleFeedbackView, OutingFeedbackView, ThreadLifecycleView
    ...
    class ThreadLifecycleView(discord.ui.View):
        """Persistent cleanup controls for normal Hermes Discord thread replies."""
