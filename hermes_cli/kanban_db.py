...
class Task:
    ...
    def from_row(cls, row: sqlite3.Row) -> "Task":
        ...
        return cls(
            ...
            created_at=_to_epoch(row["created_at"]) or 0,
            started_at=_to_epoch(row["started_at"]),
            completed_at=_to_epoch(row["completed_at"]),
...
class Run:
    ...
    def from_row(cls, row: sqlite3.Row) -> "Run":
        ...
        return cls(
            ...
            started_at=_to_epoch(row["started_at"]) or 0,
            ended_at=_to_epoch(row["ended_at"]),
            outcome=row["outcome"],
            summary=row["summary"],
            metadata=meta,
            error=row["error"],
